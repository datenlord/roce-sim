...
class Configure:
    ...
    def check(self):
        ...
        check_ip_port(Configure.SIDE1, side_1.get(Configure.IP), side_1.get(Configure.PORT))
        check_ip_port(Configure.SIDE2, side_2.get(Configure.IP), side_2.get(Configure.PORT))
